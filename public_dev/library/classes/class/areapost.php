...
class class_areapost extends Zend_Db_Table_Abstract
{
   //declare table variables
	...
	public function search($query, $limit = 20) {
		...
		$select = $this->_db->select()
						->from(array('areapost' => 'areapost'), array('areapost.areapost_code', 'areapost.areapost_suburb', 'areapost.areapost_city', 'areapost.areapost_box', 'areapost.areapost_name'))		
					   ->where("areapost.areapost_name like lower(?)", "%$query%")
					   ->limit($limit)
					   ->order("LOCATE('$query', areapost.areapost_name)");
	...
	public function getByName($name) {
		...
		$select = $this->_db->select()
						->from(array('areapost' => 'areapost'), array('areapost.areapost_code', 'areapost.areapost_suburb', 'areapost.areapost_city', 'areapost.areapost_box', 'areapost.areapost_name'))		
					   ->where("areapost.areapost_suburb = lower(?)", $name);
