  ...
  <div id="content">
    ...
    <div id="sidetabs">
        <ul > 
			...
			<li><a href="/company/view/service.php?code={$companyData.company_code}" title="Services">Services</a></li>
        </ul>
    </div><!--tabs-->

	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/company/view/category.php?code={$companyData.company_code}" method="post"  enctype="multipart/form-data">
	<table width="100%" class="innertable" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		<td>{$item.companyservice_name}</a></td>																		
		<td>
...
function updateForm(id) {
	if(confirm('Are you sure you want to update this file ?')) {
		...
		$.ajax({ 
				type: "GET",
				url: "category.php",
				data: "code={/literal}{$companyData.company_code}{literal}&update_code="+id+"&companyservice_primary="+primary,
				dataType: "json",
