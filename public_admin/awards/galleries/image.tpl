...
{include_php file='includes/header.php'}
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/awards/galleries/" title="">Gallery</a></li>
			<li><a href="/awards/galleries/details.php?code={$galleryData.gallery_code}" title="">{$galleryData.gallery_name}</a></li>
			<li>Images</li>
        </ul>
	</div><!--breadcrumb--> 	
	 <div class="inner">
    ...
    <div id="sidetabs">
        <ul >             
			<li><a href="/awards/galleries/details.php?code={$galleryData.gallery_code}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Images">Images</a></li>
        </ul>
    </div><!--tabs-->	
	<div class="detail_box">
	<form id="addForm" name="addForm" action="/awards/galleries/image.php?code={$galleryData.gallery_code}" method="post" enctype="multipart/form-data">
	<table width="100%" class="innertable" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		<td><a target="_blank" href="http://www.under35mavericks.com/{$item.galleryimage_path}/big_{$item.galleryimage_code}{$item.galleryimage_ext}"><img src="http://www.under35mavericks.com/{$item.galleryimage_path}/tny_{$item.galleryimage_code}{$item.galleryimage_ext}" /></a></td>											
