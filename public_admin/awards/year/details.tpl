...
<div id="container">
  ...
  <div id="content">
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/awards/year/details.php{if isset($yearData)}?code={$yearData.year_code}{/if}" method="post">
    ...
    <div class="clearer"><!-- --></div>
        <div class="mrg_top_10">
          <a href="/awards/year/" class="button cancel mrg_left_147 fl"><span>Cancel</span></a>
