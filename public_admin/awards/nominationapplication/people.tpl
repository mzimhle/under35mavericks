  ...
  <div id="content">
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/awards/nominationapplication/details.php?code={$applicationData.participant_code}" title="{$applicationData.application_name} {$applicationData.application_surname}">{$applicationData.application_name} {$applicationData.application_surname}</a></li>
    ...
    <div id="sidetabs">
        <ul > 
            <li><a href="/awards/nominationapplication/details.php?code={$applicationData.application_code}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="People">People</a></li>			
        </ul>
    </div><!--tabs-->		  
		  <div class="detail_box">  
		  <form name="peopleForm" id="peopleForm" action="/awards/nominationapplication/people.php?code={$applicationData.application_code}" method="post">
