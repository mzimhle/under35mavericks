...
{include_php file='includes/header.php'}
	...
	<table width="100%" class="innertable" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		<td><a target="_blank" href="{$item.galleryimage_path}/big_{$item.galleryimage_code}{$item.galleryimage_ext}"><img src="{$item.galleryimage_path}/tny_{$item.galleryimage_code}{$item.galleryimage_ext}" /></a></td>											
