 ...
 */
if(!function_exists('dateToTimestampCsp')) {
    function dateToTimestampCsp($date) {
        if(empty($a))
            return false;
        $a = explode(CSP_DATE_DL, $date);
...
if(!function_exists('importClassCsp')) {
 ...
 */
if(!function_exists('toeGetClassNameCsp')) {
    function toeGetClassNameCsp($class) {
        $className = '';
		if(class_exists($class. strFirstUp(CSP_CODE))) 
			$className = $class. strFirstUp(CSP_CODE);
		else if(class_exists(CSP_CLASS_PREFIX. $class)) 
            $className = CSP_CLASS_PREFIX. $class;
		else
            $className = $class;
        return $className;
    } 
 ...
 */
if(!function_exists('toeCreateObjCsp')) {
 ...
 * @return array
 */
if(!function_exists('prepareParamsCsp')) {
...
if(!function_exists('prepareFieldCodeCsp')) {
	function prepareFieldCodeCsp($string) {   
