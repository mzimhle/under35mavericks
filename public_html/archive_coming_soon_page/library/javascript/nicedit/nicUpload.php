...
define('NICUPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].'/media/upload/'.date('Y-m-d').'/'); // Set the path (relative or absolute) to
 // the directory to save image files
                                      
define('NICUPLOAD_URI', 'http://'.$_SERVER['HTTP_HOST'] .'/media/upload/'.date('Y-m-d'));   // Set the URL (relative or absolute) to
// the directory defined above

if(!is_dir(NICUPLOAD_PATH)) mkdir(NICUPLOAD_PATH, 0777, true);
